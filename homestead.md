...
Once you have edited the `Homestead.yaml` to your liking, it is time to boot up your Homestead. If you chose option 1 earlier `vagrant init laravel/homestead` command in your Homestead directory and than `vagrant up` command to launch. If you installed with option 2 just `homestead up` command from your Homestead directory.
